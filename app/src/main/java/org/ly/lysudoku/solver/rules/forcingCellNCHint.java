...
public class forcingCellNCHint extends IndirectHint implements Rule, HasParentPotentialHint {
    ...
    public forcingCellNCHint(forcingCellNC rule, Map<Cell, BitSet> removablePotentials, Cell forcingCell, int[] Values) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof forcingCellNCHint))
            return false;
        forcingCellNCHint other = (forcingCellNCHint)o;
