 ...
 * lockedNC hints
 */
public class lockedNCHint extends IndirectHint implements Rule, HasParentPotentialHint {
    ...
    public lockedNCHint(lockedNC rule, Map<Cell, BitSet> removablePotentials, Cell[] lockedCells, int[] Values, Grid.Region region, int value) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof lockedNCHint))
            return false;
        lockedNCHint other = (lockedNCHint)o;
