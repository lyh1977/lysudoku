package org.ly.lysudoku.gui.importing;
...
import org.ly.lysudoku.db.SudokuImportParams;
import org.ly.lysudoku.db.SudokuInvalidFormatException;
import org.ly.lysudoku.game.FolderInfo;
import org.ly.lysudoku.utils.Const;
 ...
 * 3) Add code to {@link org.ly.lysudoku.gui.SudokuImportActivity} which creates instance of your new class and
